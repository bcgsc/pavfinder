...
def parse_args():
    ...
    sv.add_argument("--check_alt_paths", dest="check_alt_paths", 
    ...
    support.add_argument("--allow_clipped_normal", help="allow using clipped reads in gathering normal read support",
                         action="store_true", default=False)
    support.add_argument("--support_min_mapped",
    ...
    output.add_argument("--insertion_as_breakends", 
...
def main():
    ...
    if args.r2c:
        support_script = '{}/check_support.py'.format(os.path.dirname(__file__))
