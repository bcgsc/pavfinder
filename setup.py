...
setup(
    ...
    data_files = [('config', ['pavfinder/cfg/tap.cfg']), 
                  ...
                  ('test/transcriptome', ["pavfinder/test/transcriptome/c2g.bam",
                                          ...
                                          "pavfinder/test/transcriptome/test.fa.fai",
                  ...
                  ('test/trancriptome/expected_output/pavfinder', ["pavfinder/test/transcriptome/expected_output/pavfinder/junctions.bed",
                  ...
                  ('test/trancriptome/expected_output', ["pavfinder/test/transcriptome/expected_output/tap.tar.gz"]),
                  ],
